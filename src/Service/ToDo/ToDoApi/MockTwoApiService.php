...
class MockTwoApiService implements IToDo
{
    const GET_TO_DO_ENDPOINT = ['method' => 'GET', 'path' => 'mock-two'];
    ...
    private function prepareContent($contents): array
    {
        ...
        foreach ($contents as $content) {
            ...
            $createType->setDifficulty($content->zorluk);
            $createType->setDuration($content->sure);
